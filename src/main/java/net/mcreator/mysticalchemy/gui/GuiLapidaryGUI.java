...
package net.mcreator.mysticalchemy.gui;
...
public class GuiLapidaryGUI extends ElementsMysticAlchemy.ModElement {
	public static int GUIID = 1;
	public static HashMap guistate = new HashMap();
	public GuiLapidaryGUI(ElementsMysticAlchemy instance) {
		super(instance, 5);
	}
	...
	public static class GuiContainerMod extends Container implements Supplier<Map<Integer, Slot>> {
		...
		private void slotChanged(int slotid, int ctype, int meta) {
			if (this.world != null && this.world.isRemote) {
				MysticAlchemy.PACKET_HANDLER.sendToServer(new GUISlotChangedMessage(slotid, x, y, z, ctype, meta));
	...
	public static class GuiWindow extends GuiContainer {
		...
		private static final ResourceLocation texture = new ResourceLocation("mysticalchemy:textures/lapidarygui.png");
		@Override
		...
		protected void drawGuiContainerForegroundLayer(int par1, int par2) {
			this.fontRenderer.drawString("Lapidary", 5, 4, -6710887);
			this.fontRenderer.drawString("Refining:" + ((int) entity.getEntityData().getDouble("timeRemaining")) + "%", 104, 5, -6710887);
		}
		...
		protected void actionPerformed(GuiButton button) {
			MysticAlchemy.PACKET_HANDLER.sendToServer(new GUIButtonPressedMessage(button.id, x, y, z));
